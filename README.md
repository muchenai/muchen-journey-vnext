...
- WP-09：独立飞书应用、首位真实 Operator、Reviewer 绑定及真实权限矩阵已完成；Reviewer 授权访问、Operator 越权拒绝、旧会话轮换、身份撤销立即失效和安全审计脱敏均通过。撤销后的页面仍把 401 显示为通用错误，本地修复和 standalone 响应测试已通过，待形成候选并部署复验后关闭 WP-09；
