...
[[ "${WP31_EDGE_SOURCE:-}" =~ ^/srv/journey-next-production/canary/releases/1633ec4eabe381da3b56500c323005c0f363c0d9-[1-9][0-9]*/Caddyfile\.(canary|rollback)$ ]] || fail "edge source is invalid"
...
[[ "$WP31_EDGE_MODE" == canary ]] && expected=1633ec4eabe381da3b56500c323005c0f363c0d9
