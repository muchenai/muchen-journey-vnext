...
ci-fast:
	$(MAKE) web-install
	$(MAKE) traceability-check legacy-reference-scan wp08-web-only-check wp08-workflow-check wp11-staging-audit-check wp12-hardening-check wp12b-contract-check wp13-15-plan-check secret-scan dependency-audit
