...
| 23 | [G4–G6 下一批工作包定义](23_G4_G6_NEXT_WORK_PACKAGES.md) | WP-07～WP-15 如何按单一 WIP 推进候选、试点与正式切换？ | WP-07 已关闭；WP-08 的 Alpha staging 运行面已验证，物理 ACL 证据债保留到 RC/production 前关闭；当前只激活 WP-09 |
...
| 27 | [WP-09 真实身份与会话构建证据](27_WP09_REAL_IDENTITY_SESSION_EVIDENCE.md) | 飞书身份绑定、真实会话和撤销边界在代码与物理环境分别证明了什么？ | 本地实现、Operator 最小身份运营界面和机器负测已通过；独立飞书应用、真实账号和 staging 身份 UAT 仍 `NOT_RUN` |
