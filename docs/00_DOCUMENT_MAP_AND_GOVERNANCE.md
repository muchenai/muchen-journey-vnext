...
| 32 | [WP-12B 多租户容量与隔离门禁证据](32_WP12B_MULTI_TENANT_LOAD_AND_ISOLATION_EVIDENCE.md) | 十几个真实组织上线前如何证明多租户并发容量、隔离和事实唯一性？ | 正式 20 组织/500 Learner 运行的隔离、事实审计和退役 PASS，但三条写路径性能 FAIL；该 run 不得重试，WP-13 暂不启动 |
