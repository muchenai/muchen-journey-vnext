...
| 12 | [决策、风险与开放问题台账](12_DECISION_RISK_AND_OPEN_QUESTIONS.md) | 哪些决定已锁定，哪些仍阻塞开工？ | 所有 `BLOCKS_G0` 项关闭；DEC-017 锁定 Alpha/RC 无附件边界 |
...
| 23 | [G4–G6 下一批工作包定义](23_G4_G6_NEXT_WORK_PACKAGES.md) | WP-07～WP-15 如何按单一 WIP 推进候选、试点与正式切换？ | WP-07/WP-08 已关闭；WP-10 按 Alpha/RC 无附件边界关闭；WP-09 真人提示待人工 UAT；WP-11 已部署且主机审计通过，但 TLS 外部采集/真实通知/告警仍未关闭；WP-12 尚未激活 |
...
| 29 | [WP-11 真实通知与外部可观测构建证据](29_WP11_NOTIFICATION_OBSERVABILITY_EVIDENCE.md) | 加密接收人、真实飞书适配器、回执、重驱、结构化日志和外部观测合同分别证明了什么？ | 候选 `172c9f6…` 已部署，独立通知应用/secrets 与主机观测通过；TLS topic 仍无日志，未配置接收人、未发消息、未完成告警演练，当前结论为 `INTEGRATIONS_AND_OBSERVABILITY_NO_GO` |
