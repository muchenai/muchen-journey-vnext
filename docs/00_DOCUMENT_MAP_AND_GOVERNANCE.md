...
| 32 | [WP-12B 多租户容量与隔离门禁证据](32_WP12B_MULTI_TENANT_LOAD_AND_ISOLATION_EVIDENCE.md) | 十几个真实组织上线前如何证明多租户并发容量、隔离和事实唯一性？ | Reviewer 优化候选已部署并通过外部/browser smoke；正式 20 组织 staging 运行仍 `NOT_RUN`，WP-13 暂不启动 |
