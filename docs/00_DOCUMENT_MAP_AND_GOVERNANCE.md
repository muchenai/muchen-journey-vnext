...
| 31 | [WP-13～WP-15 真人、时间与生产门禁执行包](31_WP13_WP15_EXECUTION_GATE_KIT.md) | 如何确保真人 UAT、14 天试点和生产批准不被自动化假证据替代？ | 首次 WP-13 真人 UAT 因邀请入口 SEV2 停止；DEC-021 新候选已生成且 pending 重绑定，但未部署、不可恢复 UAT；WP-14/15 未开始，production 为 `NO_GO` |
