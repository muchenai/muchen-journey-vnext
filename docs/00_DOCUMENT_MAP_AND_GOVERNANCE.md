...
| 23 | [G4–G6 下一批工作包定义](23_G4_G6_NEXT_WORK_PACKAGES.md) | WP-07～WP-15 如何按单一 WIP 推进候选、试点与正式切换？ | WP-07/WP-08/WP-09 已关闭；WP-10 按 Alpha/RC 无附件边界关闭；WP-11 已部署且主机审计通过，但 TLS 外部采集/真实通知/告警仍未关闭；WP-12 尚未激活 |
