...
| 23 | [G4–G6 下一批工作包定义](23_G4_G6_NEXT_WORK_PACKAGES.md) | WP-07～WP-15 如何按单一 WIP 推进候选、试点与正式切换？ | WP-07 已关闭；WP-08 的 Alpha staging 运行面已验证，物理 ACL 证据仍有一项供应商字段缺口；WP-09～WP-15 未激活 |
