...
| 27 | [WP-09 真实身份与会话构建证据](27_WP09_REAL_IDENTITY_SESSION_EVIDENCE.md) | 飞书身份绑定、真实会话和撤销边界在代码与物理环境分别证明了什么？ | Reviewer/Operator 真人权限、轮换、撤销和日志脱敏矩阵已通过；明确会话失效提示修复待候选部署复验 |
