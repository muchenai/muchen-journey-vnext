...
> 状态：`PRODUCT_OWNER_SUPPLEMENT_COMPLETE / G1_CONTENT_BINDING_PASS / NO_RELEASE`
>
...
- `MODULE_OWNER_HASH_SIGNATURES=APPROVED_3_PEOPLE_4_MODULES_BY_PRODUCT_OWNER_ATTESTATION`
- `EXPLORATION_SOURCE_VERSION_BINDING=PASS_METADATA_BINDING_NOT_FULL_EXPORT`
- `FORMAL_CONTENT_PACKAGES=PASS_4_MODULES`
- `OWNER_CONTENT_BINDING_REQUIRED=CLOSED`
