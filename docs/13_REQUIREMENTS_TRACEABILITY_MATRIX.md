...
| WP-13 内容校准与真人 UAT | DEC-007/010/016/020/021；AT-UAT-001..008；AT-CONTENT-001..008；AT-UX-001/002/004/005/007 | 活动计划仍绑定已部署旧候选；独立 pending rebind 合同绑定新候选 `222096db…`、Mainline run/manifest/三镜像摘要和 Web-only 不变量；固定角色人数、8 场景、三类 Reviewer 校准、六项可访问性、5 秒理解阈值、Sev-1/2 和五角色签署的 fail-closed validator；运营邀请入口复用既有 scoped invite create/list/revoke 合同；见 31 | 首次真人执行在 `AT-UAT-003` 停止并记 `UAT-WP13-001`/SEV2。PR #94 已合入，run `30550010916` 已生成并验证新候选；API/Worker/迁移/OpenAPI/锁文件/Compose 未漂移，未重跑 WP-12B。新候选尚未部署，pending 合同固定 resume=false，原失败证据不变 | `HUMAN_UAT_STOPPED / UAT-WP13-001_SEV2 / NEW_CANDIDATE_GENERATED / REBIND_PENDING_STAGING_DEPLOY / NO_GO` |
