...
| WP-13 内容校准与真人 UAT | DEC-007/010/016/020/021；AT-UAT-001..008；AT-CONTENT-001..008；AT-UX-001/002/004/005/007 | 活动计划与 rebind 合同精确绑定 Web 候选 `222096db…`、repair run `30616573615`、API/Worker 基线 `02863d0…`、migration `0014`；固定角色、场景、校准、可访问性与签署门禁。`UAT-WP13-002` 修复新增同组织 Operator scoped、expected revision、幂等、30 分钟一次性 Learner 重新进入合同；确认只轮换 session，并以对象/事实计数回归证明不创建或改写原业务闭环；见 31 | Round-2 完成真实邀请、提交和 `REQUEST_REVISION` 后，Learner 因 8 小时 session 与 2 工作日反馈 SLA 冲突而无法返回修订工作区，按 `UAT-WP13-002/SEV2` 停止。失败截图保持；修复当前仅为本地代码与机器测试，未部署、未真人复验 | `UAT-WP13-002_SEV2 / REPAIR_CODE_READY_NOT_DEPLOYED / HUMAN_UAT_STOPPED / NO_GO` |
