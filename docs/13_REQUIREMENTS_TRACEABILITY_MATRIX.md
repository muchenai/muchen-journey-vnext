...
| WP-13 内容校准与真人 UAT | DEC-007/010/016/020/021；AT-UAT-001..008；AT-CONTENT-001..008；AT-UX-001/002/004/005/007 | 活动计划与 rebind 合同现精确绑定 Web 候选 `222096db…`、repair run `30616573615`、API/Worker 基线 `02863d0…`、migration `0014` 和 Web-only 不变量；固定角色人数、8 场景、三类 Reviewer 校准、六项可访问性、5 秒理解阈值、Sev-1/2 和五角色签署的 fail-closed validator；运营邀请入口复用既有 scoped invite create/list/revoke 合同；见 31 | 首次真人执行在 `AT-UAT-003` 停止并记 `UAT-WP13-001`/SEV2，原失败证据保留。PR #94 的修复候选经唯一 repair run `30616573615` 恢复为 Web=`222096db…`、API/Worker/heartbeat=`02863d0…`，公开 readiness/权限拒绝与 SSH 清理通过，未重跑 WP-12B；技术 UAT 入口已恢复，但新一轮 5 Learner、2 Reviewer、8 场景、可访问性与五角色签署均未执行 | `HUMAN_UAT_READY / UAT-WP13-001_REPAIRED / REBIND_ACTIVE / HUMAN_EVIDENCE_NOT_RUN / NO_GO` |
