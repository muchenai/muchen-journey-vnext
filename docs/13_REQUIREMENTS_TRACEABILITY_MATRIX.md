...
| WP-13 内容校准与真人 UAT | DEC-007/010/016/020；AT-UAT-001..008；AT-CONTENT-001..008；AT-UX-001/002/004/005/007 | 计划精确绑定候选 `02863d0…` 和 DEC-020 入口；固定角色人数、8 场景、三类 Reviewer 校准、六项可访问性、5 秒理解阈值、Sev-1/2 和五角色签署的 fail-closed validator；运营邀请入口复用既有 scoped invite create/list/revoke 合同，以可读 Reviewer/TaskVersion 选择生成 fragment token 链接；见 31 | 首次真人执行在 `AT-UAT-003` 停止：Operator 60 秒内找不到 `/ops` 邀请入口，记 `UAT-WP13-001`/SEV2；修复仅在代码候选中准备，未部署、未重绑 UAT，原失败证据不变 | `HUMAN_UAT_STOPPED / UAT-WP13-001_SEV2 / FIX_PREPARED_NOT_DEPLOYED / NO_GO` |
