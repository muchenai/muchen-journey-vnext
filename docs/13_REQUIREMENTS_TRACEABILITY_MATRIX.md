...
| WP-13 内容校准与真人 UAT | DEC-007/010/016/020/021；AT-UAT-001..008；AT-CONTENT-001..008；AT-UX-001/002/004/005/007 | 活动计划保留当前 Web=`222096db…`、API/Worker=`02863d0…`、repair run `30616573615` 的已部署事实；rebind v2 精确绑定修复候选 `8f77ceec…`、Mainline run `30709982868`、manifest/GHCR 摘要与 API/Web/OpenAPI 变化边界。`UAT-WP13-002` 修复新增同组织 Operator scoped、expected revision、幂等、30 分钟一次性 Learner 重新进入合同；确认只轮换 session，并以对象/事实计数回归证明不创建或改写原业务闭环；见 31 | Round-2 的真实邀请、提交、`REQUEST_REVISION` 和 Learner 会话失败事实保持。修复候选已生成并完成 fail-closed 绑定，但 API/公开合同候选漂移使 DEC-020 性能继承必须重新评估；尚未部署、未真人复验 | `UAT-WP13-002_SEV2 / REPAIR_CANDIDATE_BOUND_PENDING_STAGING_DEPLOY / HUMAN_UAT_STOPPED / NO_GO` |
