...
| WP-13 内容校准与真人 UAT | DEC-007/010/016/020；AT-UAT-001..008；AT-CONTENT-001..008；AT-UX-001/002/004/005/007 | 计划精确绑定候选 `02863d0…` 和 DEC-020 入口；固定角色人数、8 场景、三类 Reviewer 校准、六项可访问性、5 秒理解阈值、Sev-1/2 和五角色签署的 fail-closed validator；见 31 | Alpha 入口已批准且候选已冻结；私有名册、日期/Recorder/联系人、校准样本、真人执行与签署尚未提供 | `AUTHORIZED / CANDIDATE_BOUND / HUMAN_UAT_NOT_RUN / NO_GO` |
